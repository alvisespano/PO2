...
// Questo sorgente contiene le soluzioni dell'esame scritto di PO2 del 25/6/2024 per ciò che riguarda il quesito 2, ovvero la domanda che coinvolge C++.
...
public:
	...
	matrix(size_t rows, size_t cols_, const T& v = T()) : cols(cols_), v(rows* cols, v) {}
